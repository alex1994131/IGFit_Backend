...
export declare enum InstrumentUnit {
    AMOUNT = "AMOUNT",
    CONTRACTS = "CONTRACTS",
    SHARES = "SHARES"
}
...
export declare class MarketAPI {
     ...
     */
    searchMarkets(searchTerm: string): Promise<MarketSearch>;
    /**
     ...
     */
    getMarketCategories(nodeId?: string): Promise<MarketNavigation>;
    /**
     ...
     */
    getMarketDetails(epic: string): Promise<MarketDetail>;
    getMarketDetails(epic: string[]): Promise<MarketDetails>;
}
