...
export declare enum ResolutionInMillis {
    DAY = 86400000,
    HOUR = 3600000,
    HOUR_2 = 7200000,
    HOUR_3 = 10800000,
...
export declare class PriceAPI {
     ...
     */
    getPricesBetweenDates(epic: string, resolution: Resolution, startDate: string, endDate: string, pageSize?: number, pageNumber?: number): Promise<HistoricalPricesResponse>;
    /**
     ...
     * @param pageNumber - Page of results to return (pagination)
     */
    getPrices(epic: string, resolution: Resolution, pointCount: number, pageSize?: number, pageNumber?: number): Promise<HistoricalPricesResponse>;
}
