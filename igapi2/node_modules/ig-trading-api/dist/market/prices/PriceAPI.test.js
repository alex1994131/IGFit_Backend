...
describe('PricesAPI', () => {
    describe('getPrices', () => {
        it('returns the number of price points from now', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            nock_1.default(APIClient_1.APIClient.URL_DEMO)
                ...
                instrumentType: MarketAPI_1.InstrumentType.CURRENCIES,
                metadata: {
            ...
            const getPrices = yield global.client.rest.market.price.getPrices('CS.D.GBPUSD.TODAY.IP', PriceAPI_1.Resolution.HOUR_4, 5);
            expect(getPrices.prices.length).toBe(expectedPrices.length);
            expect(getPrices.instrumentType).toBe(MarketAPI_1.InstrumentType.CURRENCIES);
        }));
    });
    describe('getPricesBetweenDates', () => {
        it('returns prices between given dates', () => __awaiter(void 0, void 0, void 0, function* () {
            const expectedPrices = [
                {
            ...
            const getPricesBetweenDates = yield global.client.rest.market.price.getPricesBetweenDates('CS.D.GBPUSD.TODAY.IP', PriceAPI_1.Resolution.HOUR_4, '2021-01-15T00:00:00.000Z', '2021-01-16T00:00:00.000Z');
            expect(getPricesBetweenDates.prices.length).toBe(expectedPrices.length);
            expect(getPricesBetweenDates.instrumentType).toBe(MarketAPI_1.InstrumentType.CURRENCIES);
        }));
    });
});
//# sourceMappingURL=PriceAPI.test.js.map