...
describe('MarketAPI', () => {
    describe('searchMarkets', () => {
        it('returns all markets matching the search term', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const marketSearch = yield global.client.rest.market.searchMarkets('PFE');
    ...
    describe('getMarketCategories', () => {
        it('returns all top-level nodes (market categories) in the market navigation hierarchy', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const marketCategories = yield global.client.rest.market.getMarketCategories();
        ...
        it('returns all sub-nodes of the given node in the market navigation hierarchy', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const marketCategories = yield global.client.rest.market.getMarketCategories(nodeId);
    ...
    describe('getMarketDetails', () => {
        it('returns the details of the given market', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const marketDetails = yield global.client.rest.market.getMarketDetails(epic);
            expect(marketDetails.snapshot.bid).toBe(6524.8);
        }));
        it('returns the details of multiple epics', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const { marketDetails } = yield global.client.rest.market.getMarketDetails(epics);
            expect(marketDetails[1].snapshot.high).toBe(41.4);
        }));
    });
});
//# sourceMappingURL=MarketAPI.test.js.map