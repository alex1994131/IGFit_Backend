 ...
 * Version 8.0.3 build 1787
 * Copyright (c) Lightstreamer Srl. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0
 *   See http://www.apache.org/licenses/LICENSE-2.0
 * Contains: LightstreamerClient, Subscription, RemoteAppender, LogMessages, 
 *   BufferAppender, ConsoleAppender, FunctionAppender, SimpleLoggerProvider
 *   
 */
'use strict';
...
var Constants = /*@__PURE__*/(function() {
   ...
   */
    ...
    BUILD: '1787',
    LIBRARY_VERSION: '8.0.3',
    LIBRARY_NAME: 'nodejs',
    LIBRARY_TAG: 'nodejs_client',
    LS_CID: 'tqGko0tg4pkpW3DAK3P4hwLri8LBUEn',
...
var actionsLogger = LoggerManager.getLoggerProxy(Constants.ACTIONS);
  ...
  Bean.prototype = {
    ...
    /*public*/ simpleSetter: function(prop,_value) {
      ...
      //actionsLogger.logDebug(LoggerManager.resolve(366),this.parent,prop,this.getValueForLog(propName));
    ...
    /*protected*/ heavySetter: function(prop,_value) {
      ...
      if(_value != this[propName]) {//obviously notify changes only if the value is actually changed
        ...
        //actionsLogger.logInfo(LoggerManager.resolve(367),prop,this.getValueForLog(propName));
    ...
    /*private*/ broadcastSetting: function(prop) { 
      var propName = this.getPropName(prop);
      //sharingLogger.logDebug(LoggerManager.resolve(368),prop,this.getValueForLog(propName));
    ...
    notifyChange: function(prop) {
      ...
      if (this.parent && this.parent.notifyOptionChange) {
        ...
        //actionsLogger.logDebug(LoggerManager.resolve(369),prop,this.getValueForLog(propName));
...
var log$1 = LoggerManager.getLoggerProxy(Constants.SESSION);
    ...
    ConnectTimeoutCounter.prototype = {
            ...
            resetConnectTimeout: function(delay) {
                this.initConnectTimeout(delay);
                if (log$1.isDebugLogEnabled()) {
                    log$1.debug("Reset currentConnectTimeout: " + this.currentConnectTimeout);
                }
            },
            ...
            increaseConnectTimeout: function() {
                if (this.connectAttempt >= 9 && this.currentConnectTimeout < this.maxConnectTimeout) {
                    ...
                    if (log$1.isDebugLogEnabled()) {
                        log$1.debug("Increase currentConnectTimeout: " + this.currentConnectTimeout);
                    }
                }
                this.connectAttempt++;
            },
            ...
            increaseConnectTimeoutToMax: function() {
                this.currentConnectTimeout = this.maxConnectTimeout;
                if (log$1.isDebugLogEnabled()) {
                    log$1.debug("Increase currentConnectTimeout to max: " + this.currentConnectTimeout);
                }
            },
...
/*
  ...
  varNames$1 = Utils.getReverse(varNames$1); 
  ...
  var ASSERT = {
    ...
    compareArrays: function(arr1,expected,sameOrder) {
      if (arr1.length != expected.length) {
        this.failInternal();
        logger.logError(LoggerManager.resolve(370),arr1,expected);
        return false;
      }
      ...
      if (!sameOrder) {
        ...
        for (var i=0; i<expected.length; i++) {
          if (!genMap[expected[i]]) {
            logger.logError(LoggerManager.resolve(371),expected[i]);
            this.failInternal();
            return false;
          } else {
            genMap[expected[i]]++;
        ...
        for (var i in genMap) {
          if (genMap[i] == 1) {
            logger.logError(LoggerManager.resolve(372),genMap[i]);
            this.failInternal();
            return false;
          }
        }
        ...
        for (var i=0; i<arr1.length; i++) {
          if(arr1[i] != expected[i]) {
            logger.logError(LoggerManager.resolve(373), arr1[i], expected[i]);
            this.failInternal();
            return false;
          }
        }
    ...
    verifyNotNull: function(val1) {
      if (val1 === null) {
        this.failInternal();
        logger.logError(LoggerManager.resolve(374),val1);
        return false;
      }
      return true;
    },
    ...
    verifyValue: function(val1,val2,compareFun) {
      ...
      if (!ok) {
        this.failInternal();
        logger.logError(LoggerManager.resolve(375),val1,val2);
        return false;
      }
      return true;
    },
    ...
    verifyDiffValue: function(val1,val2,strict) {
      ...
      if (!ok) {
        this.failInternal();
        logger.logError(LoggerManager.resolve(376),val1,val2);
        return false;
      }
      return true;
    },
    ...
    verifyOk: function(val) {
      if (!val) {
        this.failInternal();
        logger.logError(LoggerManager.resolve(377));
        return false;
      }
      return true;
    },
    ...
    verifyNotOk: function(val) {
      if (val) {
        this.failInternal();
        logger.logError(LoggerManager.resolve(378));
        return false;
      }
      return true;
    },
     ...
     */
    fail: function() {
      logger.logError(LoggerManager.resolve(379));
      this.failInternal();
      return false;
    },
    ...
    verify: function(obj,method,param,res,expectingException,compareFun) {
      ...
      if (!ok) {
        this.failInternal();
        logger.logError(LoggerManager.resolve(380),what,"for",method,param,res,exc);
        return false;
      }
...
var protocolLogger = LoggerManager.getLoggerProxy(Constants.PROTOCOL);
  ...
  var RequestsHelper = {
    ...
    /*public*/ getPushCommand: function(
      ...
      //>>excludeStart("debugExclude", pragmas.debugExclude);  
        if (!ASSERT.verifyOk(sessionId)) {
          protocolLogger.logError(LoggerManager.resolve(381));
        }
      //>>excludeEnd("debugExclude");
        ...
        protocolLogger.logDebug(LoggerManager.resolve(382),res);
        ...
        protocolLogger.logDebug(LoggerManager.resolve(383),lsUrl);
    ...
    getRecoveryCommand: function(pushPhase, sessionId, policyBean, reconnectionCause, delay, askDomain, sessionRecoveryProg) {
        ...
        protocolLogger.logDebug(LoggerManager.resolve(384), LSContextParams);
    ...
    /*public*/ getDestroyParams: function(sessionId,reason) {
      ...
      protocolLogger.logDebug(LoggerManager.resolve(385));
    ...
    /*public*/ getForceRebindParams: function(rebindCause,_delay) {
      ...
      protocolLogger.logDebug(LoggerManager.resolve(386));
...
var varNames$2 = {
  ...
  varNames$2 = Utils.getReverse(varNames$2); 
...
var simple = CallDefinition.simple;
  ...
  var sharingLogger$1 = LoggerManager.getLoggerProxy(Constants.SHARING);
  ...
  NewEngineHandler.prototype = {
    ...
    setEngineId: function(id) {
      sharingLogger$1.logInfo(LoggerManager.resolve(387), this.engineType, id);
      this.engineId = id;
    },
...
//calls from pushpage handler
    ...
    onEngineDeath: function(suiciding, noHopeToAttachToAnotherEngine) {
        sharingLogger$1.logInfo(LoggerManager.resolve(388), this.engineId + " is dead");
        if (this.client) {
            this.sessionEnd(-1);
...
var log$2 = LoggerManager.getLoggerProxy("assertions");
...
function UpdateCopy(args,reuse) {
...
var subscriptionsLogger = LoggerManager.getLoggerProxy(Constants.SUBSCRIPTIONS);
  ...
  SubscriptionsHandler.prototype = {
    ...
    /*public*/ addATable: function(tableIn) {
      ...
      subscriptionsLogger.logInfo(LoggerManager.resolve(389),tableIn);
    ...
    /*public*/ removeATable: function(subscriptionOut) {
      ...
      subscriptionsLogger.logInfo(LoggerManager.resolve(390),subscriptionOut);
    ...
    /*public*/ updateSubscriptionParams: function(subscriptionChanging,changingParams) {
      ...
      //>>excludeEnd("debugExclude");
        ...
        if (this.promisesFromId[tableId]) {
          subscriptionsLogger.logDebug(LoggerManager.resolve(391),subscriptionChanging);
          var that = this;
          this.enqueueToPromise(tableId, function(tableNumber) {
            subscriptionsLogger.logDebug(LoggerManager.resolve(392),subscriptionChanging);
            that.eh.updateSubscriptionParams(tableNumber,changingParams);
          });
        } else {
            // we must possess already a tableNumber for this table
            subscriptionsLogger.logDebug(LoggerManager.resolve(393),subscriptionChanging);
    ...
    /*private*/ passTableToEngine: function(tableIn) {
      ...
      subscriptionsLogger.logDebug(LoggerManager.resolve(394));

      var tableNumPromise = this.eh.subscribeTable(tableIn.getRequestParams());
      if (this.promisesFromId[tableId]) {
          subscriptionsLogger.logDebug(LoggerManager.resolve(395), tableId);
      } else {
          //>>excludeStart("debugExclude", pragmas.debugExclude);  
      ...
      subscriptionsLogger.logDebug(LoggerManager.resolve(396),tableIn);
      var that = this;
      this.enqueueToPromise(tableId, function(tableNumber) {

        subscriptionsLogger.logDebug(LoggerManager.resolve(397),tableIn);
    ...
    enqueueToPromise: function(tableId, action) {
        ...
        if (this.promiseQueuesFromId[tableId] === 0) ; else {
        ...
        promise["then"](function(tableNumber) {
            if (that.promisesFromId[tableId] != promise) {
                ...
                subscriptionsLogger.logDebug(LoggerManager.resolve(398), tableId);
                return;
            }
            //>>excludeStart("debugExclude", pragmas.debugExclude);  
            ...
            if (that.promisesFromId[tableId] != promise) {
                // overridden (session changed?)
                subscriptionsLogger.logDebug(LoggerManager.resolve(399), tableId);
                return;
            }
            delete(that.promisesFromId[tableId]);
            delete(that.promiseQueuesFromId[tableId]);
    ...
    /*public*/ handleAllWaitingTables: function() {
      subscriptionsLogger.logDebug(LoggerManager.resolve(400));
    ...
    //>>excludeEnd("debugExclude");
      subscriptionsLogger.logDebug(LoggerManager.resolve(401),_table);
    ...
    /*public*/ pauseAllTables: function() {
      subscriptionsLogger.logDebug(LoggerManager.resolve(402));
    ...
    callTableByNum: function(tableNum, method) {
        ...
        if (_id) {
            ...
            if (this.promisesFromId[_id]) {
                subscriptionsLogger.logDebug(LoggerManager.resolve(403),tableInfo);
                var that = this;
                this.enqueueToPromise(_id, function(tableNumber) {
                    subscriptionsLogger.logDebug(LoggerManager.resolve(404),tableInfo);
                    //>>excludeStart("debugExclude", pragmas.debugExclude);  
                    Assertions.verifyValue(tableNumber, tableNum, "Wrong table number");
                    //>>excludeEnd("debugExclude");
                    if (that.tableIdsFromNum[tableNum] != _id) ; else {
                ...
                // subscriptionsLogger.logDebug(LoggerManager.resolve(405),tableInfo);
                if (tableInfo) {
                    method.apply(tableInfo);
                }
            }
            ...
            subscriptionsLogger.logDebug(LoggerManager.resolve(406),tableNum);
            var that = this;
                        ...
                        (function(tableId) {
                            that.enqueueToPromise(tableId, function(tableNumber) {
                                if (tableNumber == tableNum) {
                                    subscriptionsLogger.logDebug(LoggerManager.resolve(407),tableNum);
                                    if (that.tableIdsFromNum[tableNum] != tableId) ; else {
            ...
            subscriptionsLogger.logDebug(LoggerManager.resolve(408),n);
        }
    },
  ...
  EventDispatcher.prototype = {
      ...
      dispatchToOneListenerExecution: function(evt,params,listener,forced) {
        if (listener && listener.handler[evt] && (forced || listener.listening)) {
          try {
            ...
            //actionsLogger.logError(LoggerManager.resolve(409),evt,_e);
          }
        }
      },
      ...
      dispatchEvent: function(evt,params) {
        /*if (actionsLogger.isDebugLogEnabled()) {
          actionsLogger.logDebug(LoggerManager.resolve(410),evt);
        }*/
...
var protocolLogger$1 = LoggerManager.getLoggerProxy(Constants.PROTOCOL);
  ...
  PushEvents.prototype = {
    ...
    changeSession: function(session) {
      protocolLogger$1.logDebug(LoggerManager.resolve(411),session);
    ...
    exportMethods: function(engId) {
      ...
      Lightstreamer.exportGlobal(engId,"LS_e",function(flag, phase, arg3, controlLink, keepaliveIntervalDefault, requestLimitLength) {
        that.onPushEvent(flag, phase, arg3, controlLink, keepaliveIntervalDefault, requestLimitLength);
      });
      Lightstreamer.exportGlobal(engId,"LS_t",function(_title) {
        that.onServerTitle(_title);
      });
      Lightstreamer.exportGlobal(engId,"LS_u",function(winPhase, args, snap) {
        that.onUpdate(winPhase, args, snap);
      });
      Lightstreamer.exportGlobal(engId,"LS_v",function(winPhase, args) {
        that.onUpdate(winPhase, args, true);
      });
      Lightstreamer.exportGlobal(engId,"LS_o",function(winPhase, args) {
        that.onLostUpdatesEvent(winPhase, args);
      });
      Lightstreamer.exportGlobal(engId,"LS_n",function(winPhase, args) {
        that.onEndOfSnapshotEvent(winPhase, args);
      });
      Lightstreamer.exportGlobal(engId,"LS_s",function(winPhase, args) {
      ...
      Lightstreamer.exportGlobal(engId,"LS_l",function(flag, phase, tableCode, msg, isReqerr /*only for message errors*/) {
        that.onErrorEvent(flag, phase, tableCode, msg, isReqerr);
      });
      Lightstreamer.exportGlobal(engId,"LS_w",function(flag, phase, tableCode, its, flds, kPos, cPos) {
        that.onControlEvent(flag, phase, tableCode, its, flds, kPos, cPos);
      });
      Lightstreamer.exportGlobal(engId,"setTimeout",function(f,t) {
        setTimeout(f,t);
      });
      Lightstreamer.exportGlobal(engId,"alert",function(m) {
      ...
      Lightstreamer.exportGlobal(engId,"LS_svrname",function(name) {
          that.onServerName(name);
      });
      Lightstreamer.exportGlobal(engId,"LS_MPNREG",function(deviceId, adapterName) {
          that.onMPNREG(deviceId, adapterName);
      });
      Lightstreamer.exportGlobal(engId,"LS_MPNOK",function(lsSubId, pnSubId) {
          that.onMPNOK(lsSubId, pnSubId);
      });
      Lightstreamer.exportGlobal(engId,"LS_MPNDEL",function(pnSubId) {
...
//      }*/
      ...
      if (protocolLogger$1.isDebugLogEnabled()) {
        protocolLogger$1.logDebug(LoggerManager.resolve(412),_ok);
      }
    ...
    processCountableNotification: function() {
        ...
        protocolLogger$1.logDebug(LoggerManager.resolve(413),sessionProg);
        if (this.currentProg != null) {
            //>>excludeStart("debugExclude", pragmas.debugExclude);
            if(!ASSERT.verifyOk((this.currentProg <= sessionProg))) {
              protocolLogger$1.logError(LoggerManager.resolve(414),this.currentProg);
            }
            //>>excludeEnd("debugExclude");
            this.currentProg++;
            if (this.currentProg <= sessionProg) {
                // already seen: to be skipped
                protocolLogger$1.logDebug(LoggerManager.resolve(415),this.currentProg);
                return false;
            } else {
                ...
                if(!ASSERT.verifyValue(this.currentProg,sessionProg)) {
                  protocolLogger$1.logError(LoggerManager.resolve(416),this.currentProg);
                }
                //>>excludeEnd("debugExclude");
                return true;
            }
    ...
    onProg: function(prog, capturedMessages) {
        ...
        if (this.currentProg == null) {
            ...
            if (this.currentProg > sessionProg) {
                ...
                ASSERT.fail();
                //>>excludeEnd("debugExclude");
                protocolLogger$1.logError(LoggerManager.resolve(417),prog,sessionProg,capturedMessages);
            ...
            if (this.currentProg != prog) {
                ...
                ASSERT.fail();
                //>>excludeEnd("debugExclude");
                protocolLogger$1.logError(LoggerManager.resolve(418),prog,this.currentProg,capturedMessages);
                this.sessionHandler.onPROGCounterMismatch();
            } else if (prog != sessionProg) {
                //>>excludeStart("debugExclude", pragmas.debugExclude);
                ASSERT.fail();
                //>>excludeEnd("debugExclude");
                protocolLogger$1.logError(LoggerManager.resolve(419),prog,sessionProg,capturedMessages);
                this.sessionHandler.onPROGCounterMismatch();
            }
        }
    },
    ...
    onMessageErrorEvent: function(_code, num, messageCode, msg, isReqerr) {
      ...
      if(!ASSERT.verifyValue(messageCode.substring(0, 3),"MSG")) {
        protocolLogger$1.logError(LoggerManager.resolve(420),messageCode);
      }
      //>>excludeEnd("debugExclude");
    ...
    onControlEvent: function(flag, phase, tableCode, its, flds,kPos,cPos) {
      ...
      if (flag == 4) {
        ...
        //?
        protocolLogger$1.logDebug(LoggerManager.resolve(421),flag);
      }
...
var notifySenderName;
  for(var i$1 in  {notifySender:true}) {
    notifySenderName=i$1;
  }
...
var sharingLogger$2 = LoggerManager.getLoggerProxy(Constants.SHARING);
  ...
  PushPageCollectionHandler.prototype = {
    ...
    checkConnectionPool: function(onlyMeCount) {
      ...
      if (status && status.getNumberOfConnectionsToServer(this.engine.sessionHandler.getPushServerAddress()) > onlyMeCount) {
        sharingLogger$2.logWarn(LoggerManager.resolve(422));
      }
    },
    ...
    onNewPushPage: function(ppId,pp) {
      ...
      sharingLogger$2.logDebug(LoggerManager.resolve(423),this);
    ...
    onPushPageLost: function(ppId) {
      sharingLogger$2.logDebug(LoggerManager.resolve(424),this,ppId);
    ...
    getPushPageHandlerFromTableNumber: function(tableNum) {
      ...
      if (!sub) {
        sharingLogger$2.logDebug(LoggerManager.resolve(425));
        return null;
      }
    ...
    /*public*/ getPushPageHandler: function(pageNum) {
      if (!this.pushPages[pageNum]) {
        sharingLogger$2.logDebug(LoggerManager.resolve(426));
        return null;
      }
    ...
    /*public*/ handleTable: function(ppId,body) {
      ...
      if (!pageH || !this.engine.isSessionOpenOrRecovering()) {
        ...
        ASSERT.fail();
        //>>excludeEnd("debugExclude");
        sharingLogger$2.logError(LoggerManager.resolve(427),this,ppId);
        return;
      }
      ...
      sharingLogger$2.logDebug(LoggerManager.resolve(428));
  ...
  var MadTester = {
    ...
    /*public*/ canMakeRequest: function() {
      if (lastTime == 0) {
        ...
        sessionLogger.logError(LoggerManager.resolve(429));
        madLimit = 0;
        return false;
      }
...
var names$1 = {
    ...
    names$1 = Utils.getReverse(names$1);
  ...
  WSEncoder.prototype = {
      ...
      encodeRequest: function(params,extraParams,sessionId) {
          ...
          return this._callSuperMethod(WSEncoder,names$1['encodeRequest'],[params,extraParams,sessionId]);
      },
      ...
      encodeUnqRequest: function(params,extraParams,unquotedParam,sessionId) {
          extraParams = this.expandWithSessionId(extraParams, sessionId);
          return this._callSuperMethod(WSEncoder,names$1['encodeUnqRequest'],[params,extraParams,unquotedParam,sessionId]);
      },
...
var sessionLogger$1 = LoggerManager.getLoggerProxy(Constants.SESSION);
  ...
  function WebSocketConnection(wsSession) {
     ...
     if (streamLogger.isDebugLogEnabled()) {
         streamLogger.logDebug(LoggerManager.resolve(430), this.objectId);
     }
     this.isOpen=false;
     this.exePhase=null;
     this.openPhase=null;
  ...
  WebSocketConnection.prototype = {
    ...
    _close: function() {
      ...
      streamLogger.logDebug(LoggerManager.resolve(431));
      ...
      if (this.webSocketInstance) {
        try {
          ...
          streamLogger.logDebug(LoggerManager.resolve(432),__e);
        }
      }
    ...
    openSocket: function(request,phase,responseCallback,errorCallback,connectionEndCallback) {
      if (this.isOpen) {
        streamLogger.logError(LoggerManager.resolve(433));
      } else if(disabled) {
        return false;
      }
      ...
      try {
        ...
        streamLogger.logDebug(LoggerManager.resolve(434),_e);
        return false;
        //SECURITY_ERR
        //The port to which the connection is being attempted is being blocked.
      }

      if (sessionLogger$1.isDebugLogEnabled()) {        
          sessionLogger$1.debug("Status timeout in " + this.wsSession.getCurrentConnectTimeout() + " [currentConnectTimeoutWS]");
      }
    ...
    openWSTimeout: function(ph) {
      if (ph == this.openPhase && this.webSocketInstance && !this.openEventFired) {
        try {
          sessionLogger$1.logDebug(LoggerManager.resolve(435));
          this.wsSession.policyBean.increaseConnectTimeout();

          this.webSocketInstance.close(1000);
        } catch(_e) {
          streamLogger.logDebug(LoggerManager.resolve(436));
        }
      }
    },
    ...
    _load: function(request,phase) {
      if (this.isOpen) {
        streamLogger.logError(LoggerManager.resolve(437));
        return null;
      ...
      streamLogger.logDebug(LoggerManager.resolve(438),request.getUrl());
    ...
    //>>excludeStart("debugExclude", pragmas.debugExclude);
      if (!ASSERT.verifyOk(this.serverInUse)) {
        streamLogger.logError(LoggerManager.resolve(439));
        return false;
      }
    //>>excludeEnd("debugExclude");
    ...
    _send: function(req,ph) {
      ...
      if (streamLogger.isDebugLogEnabled()) {
          streamLogger.logDebug(LoggerManager.resolve(440), this.objectId, req.getFile(), req.getData());
      }

      try {
        this.webSocketInstance.send(req.getFile() + "\r\n" + req.getData());
      } catch(_e) {
        streamLogger.logError(LoggerManager.resolve(441),_e);
        //INVALID_STATE_ERR
    ...
    //>>excludeStart("debugExclude", pragmas.debugExclude);
      if (!ASSERT.verifyOk(res !== null)) {
        streamLogger.logError(LoggerManager.resolve(442),phase);
      }
    //>>excludeEnd("debugExclude");
      if (res) {
        this.isOpen = true;
...
///////////////////////////EVENTS
    ...
    */
    ...
    /*private*/ onPartialResponse: function(evt,phase,responseCallback) {
      ...
      if (streamLogger.isDebugLogEnabled()) {
          streamLogger.logDebug(LoggerManager.resolve(443), this.objectId, evt.data);
      }
    ...
    /*private*/ onErrorResponse: function(phase,errorCallback) {
      ...
      streamLogger.logError(LoggerManager.resolve(444), this.objectId);
    ...
    /*private*/ onOpenEvent: function(phase,req) {
      ...
      //this.openEvent = true;
      streamLogger.logDebug(LoggerManager.resolve(445));
    ...
    /*private*/ onCloseResponse: function(closeEv,phase,connectionEndCallback,errorCallback) {
      ...
      streamLogger.logDebug(LoggerManager.resolve(446),closeCode,this.openEvent);
...
/////////////////////////////////////EVENTS END
    ...
    /*public*/ setDefaultSessionId: function(defaultSessionId) {
        if (streamLogger.isDebugLogEnabled()) {
            streamLogger.logDebug(LoggerManager.resolve(447), defaultSessionId + " on WS connection oid=" + this.objectId);
        }
...
var _OFF = 1;
  ...
  var sessionLogger$2 = LoggerManager.getLoggerProxy(Constants.SESSION);
  var protocolLogger$2 = LoggerManager.getLoggerProxy(Constants.PROTOCOL);
  
  var PERMISSION_TO_FAIL = 1; //called X in the session machine
  
  var objectIdCounter$1 = 1;
  
  var Session = function(isPolling,forced,handler,handlerPhase,originalSession,skipCors,sessionRecovery,mpnManager) {
    this.objectId = objectIdCounter$1++;
    if (sessionLogger$2.isDebugLogEnabled()) {
        sessionLogger$2.logDebug(LoggerManager.resolve(448), "oid=" + this.objectId);
    }
    ...
    if (originalSession) {
      ...
      sessionLogger$2.logDebug(LoggerManager.resolve(449), this.dataNotificationCount);
  ...
  Session.prototype = {
      ...
      /*private*/ reset: function() {
        if (sessionLogger$2.isDebugLogEnabled()) {            
            sessionLogger$2.logDebug(LoggerManager.resolve(450), this.objectId);
        }
        this.bindCount = 0;
...
///////////////////////////////////phase handling
      ...
      /*private*/ changePhaseType: function(newType) {
        if (sessionLogger$2.isDebugLogEnabled()) {
            sessionLogger$2.logDebug(LoggerManager.resolve(451), this.objectId, statusStrings[this.phase], "->", statusStrings[newType]);
        }
...
//////////////////////////////////external calls
      /*public*/ createSession: function(oldSessionId,reconnectionCause,serverBusy) {
        ...
        if (!MadTester.canMakeRequest()) {
          sessionLogger$2.logDebug(LoggerManager.resolve(452),this);
          this.closeSession("mad",openOnServer,NO_RECOVERY_SCHEDULED);
          return false;
        }
        
        if (openOnServer == OPEN_ON_SERVER) {
          sessionLogger$2.logDebug(LoggerManager.resolve(453),this);
          this.closeSession("new."+(reconnectionCause||""),OPEN_ON_SERVER,RECOVERY_SCHEDULED);
        }

        sessionLogger$2.logInfo(LoggerManager.resolve(454),this);
      ...
      //>>excludeStart("debugExclude", pragmas.debugExclude);  
        if (!ASSERT.verifyOk(this.phase == PAUSE || this.phase == FIRST_PAUSE || this.phase == _OFF)) {
          sessionLogger$2.logError(LoggerManager.resolve(455));
        }
      //>>excludeEnd("debugExclude");
        ...
        if (this.isPolling) {
          sessionLogger$2.logDebug(LoggerManager.resolve(456),this);
        } else {
          sessionLogger$2.logInfo(LoggerManager.resolve(457),this);
        }
      ...
      /*public*/ requestSwitch: function(newHPhase,switchCause,forced) {
        ...
        sessionLogger$2.logDebug(LoggerManager.resolve(458),this);
        ...
        if (this.phase == CREATING || this.phase == SLEEP || this.phase == _OFF) { //Session Machine: during these statuses we do not have a session id
           ...
           */
          sessionLogger$2.logError(LoggerManager.resolve(459));
      ...
      sessionLogger$2.logDebug(LoggerManager.resolve(460),this);

      //>>excludeStart("debugExclude", pragmas.debugExclude);  
        if (!ASSERT.verifyOk(this.phase != CREATING && this.phase != SLEEP && this.phase != _OFF)) {
          sessionLogger$2.logError(LoggerManager.resolve(461));
        }
      //>>excludeEnd("debugExclude");
      ...
      /*public*/ closeSession: function(closeReason,alreadyClosedOnServer,noRecoveryScheduled) {
        sessionLogger$2.logInfo(LoggerManager.resolve(462),this,closeReason);
      ...
      /*public*/ shutdown: function(justSleep) {
        ...
        sessionLogger$2.logDebug(LoggerManager.resolve(463),this);
      },
      ...
      /*private*/ doPause: function(serverSentPause) {
        ...
        if (this.isPolling) {
          ...
          if (serverSentPause >= this.policyBean.pollingInterval) ; else {
        ...
        if (this.phase != FIRST_PAUSE && pauseToUse && pauseToUse > 0) {
          sessionLogger$2.logDebug(LoggerManager.resolve(464));
...
/////////////////////////////////////////EVENTS
      ...
      /*private*/ onTimeout: function(timeoutType, ph,usedTimeout,coreCause) {
        ...
        if (sessionLogger$2.isDebugLogEnabled()) {
            sessionLogger$2.logDebug(LoggerManager.resolve(465), timeoutType, statusStrings[this.phase], 
                    "sid", this.sessionId,
                    "cause=", coreCause,
        ...
        if (this.phase == CREATING) {
          ...
          if (this.recoveryBean.isRecovery() && timeLeftMs > 0) {
               ...
               */
              if (sessionLogger$2.isDebugLogEnabled()) {
                  sessionLogger$2.logDebug(LoggerManager.resolve(466), timeLeftMs);
              }
              this.policyBean.increaseConnectTimeout();
              this.handler.recoverSession(this.handlerPhase, tCause, this.forced);
              
          } else {	    
              sessionLogger$2.logDebug(LoggerManager.resolve(467));
          ...
          if (this.slowRequired || this.switchRequired) {
              sessionLogger$2.logDebug(LoggerManager.resolve(468));
              ...
              if (this.preparingRecovery) {
                   ...
                   */
                  sessionLogger$2.logDebug(LoggerManager.resolve(469));
                  this.handler.recoverSession(this.handlerPhase, tCause, this.forced);
                  
              } else {
                  sessionLogger$2.logDebug(LoggerManager.resolve(470));
               ...
               */
              sessionLogger$2.logDebug(this.preparingRecovery ? "Timeout: switch transport from polling (ignore recovery)" : "Timeout: switch transport from polling");
          ...
          sessionLogger$2.logWarn(LoggerManager.resolve(471),this);
        }
      ...
      /*protected*/ onErrorEvent: function(reason, args) {
        ...
        var timeLeftMs = this.recoveryBean.timeLeftMs(this.policyBean.sessionRecoveryTimeout);
        if (sessionLogger$2.isDebugLogEnabled()) {
            sessionLogger$2.logDebug(LoggerManager.resolve(472), statusStrings[this.phase], "reason=" + reason, 
                    "sid=" + this.sessionId,
                    "timeLeft=" + timeLeftMs,
        ...
        if (this.phase == RECEIVING || this.phase == _STALLED ||this.phase == STALLING ||this.phase == BINDING || this.phase == PAUSE) {
          if (startRecovery && ! this.isRecoveryDisabled) {
               ...
               */
              sessionLogger$2.logDebug(LoggerManager.resolve(473));
              ...
              sessionLogger$2.logDebug(LoggerManager.resolve(474));
          ...
          if (this.recoveryBean.isRecovery() && timeLeftMs > 0 && ! closedOnServer) {
               ...
               */
              sessionLogger$2.logDebug(LoggerManager.resolve(475));
              this.preparingRecovery = true;
              this.changePhaseType(SLEEP);              
              this.launchTimeout("currentRetryDelay", this.calculateRetryDelay(),reason);
            ...
            sessionLogger$2.logDebug(LoggerManager.resolve(476));
            ...
            this.handler.createMachine(this.handlerPhase,this.switchCause+".error",this.switchForced);
              ...
              sessionLogger$2.logDebug(LoggerManager.resolve(477), cause);
              this.closeSession(reason,closedOnServer,RECOVERY_SCHEDULED);
              //now is SLEEPing
      ...
      /*private*/ onLoop: function(serverSentPause) {
        ...
        //>>excludeStart("debugExclude", pragmas.debugExclude);  
          ASSERT.fail();
        //>>excludeEnd("debugExclude");
          sessionLogger$2.logError(LoggerManager.resolve(478),this);
        }
      },
      ...
      /*private*/ onEvent: function() {
        ...
        } else if (this.phase == CREATED) ; else if (this.phase == BINDING || this.phase == FIRST_BINDING || this.phase == STALLING || this.phase == _STALLED || this.phase == RECEIVING) {
        ...
        //>>excludeStart("debugExclude", pragmas.debugExclude);  
          ASSERT.fail();
        //>>excludeEnd("debugExclude");
          sessionLogger$2.logError(LoggerManager.resolve(479),this);
        }
...
////////////////////////////////////////////////////////actions
      ...
      //>>excludeStart("debugExclude", pragmas.debugExclude);  
        if (!ASSERT.verifyOk(this.phase == _OFF || this.phase == SLEEP)) {
          sessionLogger$2.logError(LoggerManager.resolve(480));
        }
      //>>excludeEnd("debugExclude");
      ...
      //>>excludeStart("debugExclude", pragmas.debugExclude);  
        if (!ASSERT.verifyOk(this.phase == PAUSE || this.phase == FIRST_PAUSE)) {
          sessionLogger$2.logError(LoggerManager.resolve(481),this);
        }
      //>>excludeEnd("debugExclude");
      ...
      /*protected*/ launchTimeout: function(timeoutType, triggerAfter,timeoutCause) {
           ...
           */
        if (sessionLogger$2.isDebugLogEnabled()) {        
            sessionLogger$2.logDebug(LoggerManager.resolve(482), triggerAfter, timeoutType);
        }
      ...
      //>>excludeStart("debugExclude", pragmas.debugExclude);  
        if (!ASSERT.verifyValue(this.phase,CREATED)) {
          sessionLogger$2.logError(LoggerManager.resolve(483));
        }
      //>>excludeEnd("debugExclude");
        this.launchTimeout("stalledTimeout", this.policyBean.stalledTimeout);  //we won't reconnect if this executes, so no need to add a cause
      },
...
////////////////////////////////////////////////////////timeouts      
      ...
      /*private*/ calculateReconnectTimeout: function() {
        ...
        //>>excludeStart("debugExclude", pragmas.debugExclude);  
          ASSERT.fail();
        //>>excludeEnd("debugExclude");
          sessionLogger$2.logError(LoggerManager.resolve(484),this);
          this.reconnectTimeout = null;
        }
...
///////////////////////////////////////////////SlowingEvents
      ...
      /*public*/ onSynchOk: function() {
        ...
        if (protocolLogger$2.isDebugLogEnabled()) {
          protocolLogger$2.logDebug(LoggerManager.resolve(485));
        }
...
///////////////////////////////////////////////PushEvents
      ...
      onServerSentBandwidth: function(maxBandwidth) {
        if (protocolLogger$2.isDebugLogEnabled()) {
          protocolLogger$2.logDebug(LoggerManager.resolve(486),maxBandwidth);
        }
      ...
      onError41: function() {
        if (protocolLogger$2.isDebugLogEnabled()) {
          protocolLogger$2.logDebug(LoggerManager.resolve(487));
        }
      ...
      /*public*/ onKeepalive: function() {
        if (protocolLogger$2.isDebugLogEnabled()) {
          protocolLogger$2.logDebug(LoggerManager.resolve(488));
        }
        this.onEvent();
        /*
      ...
      onOKReceived: function(newSession,controlLink,requestLimitLength,keepaliveIntervalDefault) {
        if (protocolLogger$2.isDebugLogEnabled()) {
          protocolLogger$2.logDebug(LoggerManager.resolve(489));
        }
        ...
        if (this.phase == CREATING) {
          //New session!
            if (this.sessionId != null && this.sessionId != newSession) {
                ...
                sessionLogger$2.logInfo(LoggerManager.resolve(490), newSession, this.sessionId);
                this.reset();
            }
        ...
        //>>excludeStart("debugExclude", pragmas.debugExclude);  
          if (!ASSERT.verifyValue(this.sessionId,newSession)) {
            sessionLogger$2.logError(LoggerManager.resolve(491));
          }
        //>>excludeEnd("debugExclude");
      ...
      onSyncReceived: function(secs) {
        if (protocolLogger$2.isDebugLogEnabled()) {
          protocolLogger$2.logDebug(LoggerManager.resolve(492));
        }
      ...
      /*public*/ onLoopReceived: function(serverSentPause) {
        if (protocolLogger$2.isDebugLogEnabled()) {
          protocolLogger$2.logDebug(LoggerManager.resolve(493));
        }
      ...
      /*public*/ onEnd: function(message) {
        if (protocolLogger$2.isDebugLogEnabled()) {
          protocolLogger$2.logDebug(LoggerManager.resolve(494),message);
        }
...
///////////////////////////////////////////////CONTROL      
      ...
      /*private*/ forceRebind: function(rebindCause) {  
        sessionLogger$2.logInfo(LoggerManager.resolve(495),this);
        ...
        var requestListener = {
                ...
                onREQERR: function(LS_window, phase, errorCode, errorMsg) {
                    tutor.discard();
                    sessionLogger$2.logError(LoggerManager.resolve(496) + errorCode + " " + errorMsg + " - The error will be silently ignored.");
                }
        };
      ...
      /*private*/ sendDestroySession: function(reason) { 
        sessionLogger$2.logInfo(LoggerManager.resolve(497),this);
        ...
        var requestListener = {
                ...
                onREQERR: function(LS_window, phase, errorCode, errorMsg) {
                    sessionLogger$2.logError(LoggerManager.resolve(498) + errorCode + " " + errorMsg + " - The error will be silently ignored.");
                }
        };
      ...
      changeBandwidth: function() {
        ...
        var requestListener = {
                ...
                onREQERR: function(LS_window, phase, errorCode, errorMsg) {
                    sessionLogger$2.logError(LoggerManager.resolve(499) + printObj(query) + " caused the error: ", errorCode, errorMsg);
                }
        };
...
var streamLogger$1 = LoggerManager.getLoggerProxy(Constants.STREAM);
  ...
  var objectIdCounter$2 = 1;

  function XSXHRConnection() {
     this._callSuperConstructor(XSXHRConnection);
     
     this.objectId = objectIdCounter$2++;
     if (streamLogger$1.isDebugLogEnabled()) {
         streamLogger$1.logDebug(LoggerManager.resolve(500), this.objectId);
     }
     this.isOpen=false;
  ...
  XSXHRConnection.prototype = {
    ...
    /*public*/ _close: function() {
      ...
      if (streamLogger$1.isDebugLogEnabled()) {          
          streamLogger$1.logDebug(LoggerManager.resolve(501), this.objectId);
      }
      ...
      if (this.xhrInstance) {
        try {
          ...
          streamLogger$1.logDebug(LoggerManager.resolve(502));
        }
      }
    ...
    /*public*/ _load: function(request,phase,responseCallback,errorCallback,connectionEndCallback) {
      ...
      if (streamLogger$1.isDebugLogEnabled()) {
          streamLogger$1.logDebug(LoggerManager.resolve(503), this.objectId, request.getFile(), request.getData());
      }
      ...
      try {
        ...
        streamLogger$1.logError(LoggerManager.resolve(504), this.objectId,_e);
        return false;
      }
    ...
    /*private*/ onPartialResponse: function(phase,responseCallback,connectionEndCallback,errorCallback) {
      ...
      if (this.isHttpStatusOk() && responseCallback) {
        ...
        if (streamLogger$1.isDebugLogEnabled()) {
            if (newData) {                
                streamLogger$1.logDebug(LoggerManager.resolve(505), this.objectId, newData);
            }
        }
      ...
      if (this.xhrInstance.readyState == 4) {
        if (!this.isHttpStatusOk()) {
          if (this.status0Disabled) {
            if (errorCallback) {
              if (streamLogger$1.isDebugLogEnabled) {
                  streamLogger$1.logDebug(LoggerManager.resolve(506), this.objectId);
              }
        ...
        if (streamLogger$1.isDebugLogEnabled) {
            streamLogger$1.logDebug(LoggerManager.resolve(507), this.objectId);
        }
    ...
    /*private*/ isHttpStatusOk: function() {
      try {
        ...
        streamLogger$1.logDebug(LoggerManager.resolve(508), this.objectId,_e);
        return false;
      }
    }
  };
...
// var LICENSE_ERR = "LS_window.alert('License not valid for this Client version');";
  ...
  var streamLogger$2 = LoggerManager.getLoggerProxy(Constants.STREAM);
  ...
  IEXSXHRConnection.prototype = {
    ...
    /*public*/ _close: function() {
      ...
      streamLogger$2.logDebug(LoggerManager.resolve(509));
      ...
      if (this.xDomainReqInstance) {
        try {
          ...
          streamLogger$2.logDebug(LoggerManager.resolve(510));
        }
      }
    ...
    /*public*/ _load: function(request,phase,responseCallback,errorCallback,connectionEndCallback) {
      ...
      this.xDomainReqInstance.onload = getCallback$1(loadCB);
      this.xDomainReqInstance.onerror = getCallback$1(errorCB);
      this.xDomainReqInstance.ontimeout = getCallback$1(timeoutCB);
      this.xDomainReqInstance.onprogress = getCallback$1(progressCB);
      
      this.sendPhase = phase;
      
      if (streamLogger$2.isDebugLogEnabled()) {
          streamLogger$2.logDebug(LoggerManager.resolve(511), request.getFile(), request.getData());
      }
      ...
      try {
        ...
        streamLogger$2.logError(LoggerManager.resolve(512),_e);
        return false;
      }
    ...
    /*private*/ asyncError: function(phase,errorCallback,mex) {
      ...
      streamLogger$2.logDebug(LoggerManager.resolve(513));
    ...
    /*private*/ progressEvent: function(phase,responseCallback,completed) {
      ...
      if (responseCallback) {
        ...
        if (streamLogger$2.isDebugLogEnabled()) {
            streamLogger$2.logDebug(LoggerManager.resolve(514), newData);
        }
    ...
    /*private*/ respCompleteEvent: function(phase,responseCallback,connectionEndCallback) {
      ...
      streamLogger$2.logDebug(LoggerManager.resolve(515));
...
var IFrameHandler = /*@__PURE__*/(function() {
    //Environment.browserDocumentOrDie();
...
var LEGACY_ENCODER = new LegacyEncoder();
  ...
  var streamLogger$3 = LoggerManager.getLoggerProxy(Constants.STREAM);
  ...
  FormConnection.prototype = {
    ...
    /*public*/ _close: function() {
      streamLogger$3.logDebug(LoggerManager.resolve(516));
      this.isOpen = false;
      this.loadPhase++;
    },
    ...
    /*public*/ _load: function(request,phase,responseCallback,errorCallback,connectionEndCallback) {
      ...
      try {
        ...
        if (streamLogger$3.isDebugLogEnabled()) {
            streamLogger$3.logDebug(LoggerManager.resolve(517), request.getFile(), request.getData());
        }
        ...
        streamLogger$3.logError(LoggerManager.resolve(518),_e);
        return false;
      }
...
var LEGACY_ENCODER$1 = new LegacyEncoder();

  var streamLogger$4 = LoggerManager.getLoggerProxy(Constants.STREAM);
  ...
  */
  ...
  FrameConnection.prototype = {
    ...
    /*public*/ _close: function() {
      streamLogger$4.logDebug(LoggerManager.resolve(519));
    ...
    /*private*/ _loadImpl: function(ph,request,phase,responseCallback,errorCallback) {
      ...
      if (streamLogger$4.isDebugLogEnabled()) {
          streamLogger$4.logDebug(LoggerManager.resolve(520), request.getFile(), request.getData());
      }
      ...
      try {
        ...
        if (frameRef == null) {
            streamLogger$4.logError(LoggerManager.resolve(521));
            return false;
        }
        ...
        */
        ...
        //what could I do? 
        streamLogger$4.logError(LoggerManager.resolve(522),_e);
        return false;
      }
...
//possible statuses
  ...
  var streamLogger$5 = LoggerManager.getLoggerProxy(Constants.STREAM);
  ...
  AjaxFrameHandler.prototype = {
    ...
    /*private*/ attachToGlobal: function() {
      ...
      var that = this;
      Lightstreamer.exportGlobal(this.aframeId,"LS_a",function(phase) {
    ...
    /*private*/ clean: function(ph) {
      ...
      Lightstreamer.cleanGlobal(this.aframeId,"LS_a","A");
    ...
    /*public*/ _load: function(retrying) {
      ...
      streamLogger$5.logDebug(LoggerManager.resolve(523));
      ...
      if (this.isReady()) {
        ...
        if (Utils.isOffline()) {
          ...
          streamLogger$5.logDebug(LoggerManager.resolve(524));
    ...
    /*internal*/ onAjaxFrameReady: function() {
      ...
      if (this.status != READY) {
        ...
        streamLogger$5.logDebug(LoggerManager.resolve(525));
    ...
    /*private*/ frameTimeout: function(localTimeoutPhase) {
      ...
      if (this.ajaxTimeoutPhase == localTimeoutPhase && !this.isReady()) {
        streamLogger$5.logDebug(LoggerManager.resolve(526));
    ...
    /*private*/ giveUp: function(localTimeoutPhase) {
      ...
      if (this.ajaxTimeoutPhase == localTimeoutPhase && !this.isReady()) {
        streamLogger$5.logDebug(LoggerManager.resolve(527));
    ...
    /*public*/ sendXHR: function(_url,_data,senderObject,extraHeaders) {
      ...
      streamLogger$5.logDebug(LoggerManager.resolve(528),_url);
      ...
      try {
        ...
        streamLogger$5.logDebug(LoggerManager.resolve(529),_e);
      }
...
//see (the name there are obsolete, but the flow is quite the same):
  ...
  var streamLogger$6 = LoggerManager.getLoggerProxy(Constants.STREAM);
  var COMM_START = "/"+"*";
  ...
  XHRConnection.prototype = {
    ...
    /*public*/ _load: function(request,phase,responseCallback,errorCallback,connectionEndCallback) {
      ...
      if (streamLogger$6.isDebugLogEnabled()) {
          streamLogger$6.logDebug(LoggerManager.resolve(530), request.getFile(), request.getData());
      }
    ...
    /*public*/ _close: function() {
      ...
      streamLogger$6.logDebug(LoggerManager.resolve(531));
      ...
      try {
        ...
        streamLogger$6.logError(LoggerManager.resolve(532),_ee);
      }
      this.cleanRef();
    },
    ...
    /*private*/ isHttpStatusOk: function() {
      try {
        ...
        streamLogger$6.logDebug(LoggerManager.resolve(533),_e);
        return false;
      }
    },
    ...
    //not sure if "complete" is really needed (IE6 returns 4 as the other browsers)
      if (this.sender.readyState == 4 || this.sender.readyState == "complete") { 
        ...
        if (streamLogger$6.isDebugLogEnabled()) {
          streamLogger$6.logDebug(LoggerManager.resolve(534),_data);
        }
    ...
    /*private*/ onErrorImpl: function(e) {
      ...
      streamLogger$6.logDebug(LoggerManager.resolve(535));
    ...
    /*private*/ cleanRef: function() {
       //try to remove circular reference (btw since such circle is wrapped 
        ...
        try {
          ...
          streamLogger$6.logDebug(LoggerManager.resolve(536),_e);
        }
        try {
          delete this.sender;
        } catch(_e) {
          streamLogger$6.logDebug(LoggerManager.resolve(537),_e);
        }
...
var streamLogger$7 = LoggerManager.getLoggerProxy(Constants.STREAM);
  ...
  XHRStreamingConnection.prototype = {
    ...
    /*public*/ _load: function(request,phase,responseCallback,errorCallback,connectionEndCallback) {
       ...
       streamLogger$7.logDebug(LoggerManager.resolve(538));
    ...
    /*private*/ onReadyStateChangeImpl: function(ph) {
      ...
      if (this.isHttpStatusOk() && this.response) {
        ...
        if (streamLogger$7.isDebugLogEnabled()) {
            streamLogger$7.logDebug(LoggerManager.resolve(539),newData);
        }
      ...
      if (this.sender.readyState == 4) {
        ...
        if (streamLogger$7.isDebugLogEnabled()) {
          streamLogger$7.logDebug(LoggerManager.resolve(540));
        }
...
function retFalse$1() {
    ...
    var streamLogger$8 = LoggerManager.getLoggerProxy(Constants.STREAM);
    ...
    ConnectionSelector.disableWS = function() {
      WebSocketConnection.isAvailable = retFalse$1;
    };
    ConnectionSelector.disableXHRs = function() {
      XSXHRConnection.isAvailable = retFalse$1;
      IEXSXHRConnection.isAvailable = retFalse$1;
      XHRStreamingConnection.isAvailable = retFalse$1;
      XHRConnection.isAvailable = retFalse$1;
    };
    
    ConnectionSelector.STREAMING_LIST = [];
    var strList = [XSXHRConnection,IEXSXHRConnection,XHRStreamingConnection];
    for (var i$2=0; i$2 < strList.length; i$2++) {
      if (strList[i$2].isStreamEnabled()) {
        ConnectionSelector.STREAMING_LIST.push(strList[i$2]);
      }
    }
    ...
    ConnectionSelector.isGood = function(serverToUse,toTest,isCrossSite,areCookiesRequired,isCrossProtocol,hasExtraHeaders,_list) {
      if (streamLogger$8.isDebugLogEnabled()) {
          streamLogger$8.logDebug(LoggerManager.resolve(541), getClassName(toTest));
      }
      if (!toTest.isAvailable(serverToUse)) {
        streamLogger$8.logDebug(LoggerManager.resolve(542));
        return false;
      }
      
      if (isCrossSite && !toTest.isCrossSite()) {
        streamLogger$8.logDebug(LoggerManager.resolve(543));
        return false;
      }
      ...
      if (areCookiesRequired && !toTest.areCookiesGuaranteed()) {
        ...
        streamLogger$8.logDebug(LoggerManager.resolve(544));
        return false;
      }
      
      if (isCrossProtocol && !toTest.isCrossProtocol()) {
        streamLogger$8.logDebug(LoggerManager.resolve(545));
        return false;
      }
      
      if (hasExtraHeaders && !toTest.canUseCustomHeaders()) {
        streamLogger$8.logDebug(LoggerManager.resolve(546));
        return false;
      }
      
      if (_list && !inList(toTest,_list)) {
        streamLogger$8.logDebug(LoggerManager.resolve(547));
        return false;
      }

      if (streamLogger$8.isDebugLogEnabled()) {
          streamLogger$8.logDebug(LoggerManager.resolve(548), getClassName(toTest));
      }
    ...
    ConnectionSelector.prototype = {
      ...
      /*public*/ getNext: function(serverToUse,isCrossSite,areCookiesRequired,isCrossProtocol,hasExtraHeaders) {
        if (streamLogger$8.isDebugLogEnabled()) {
            streamLogger$8.logDebug(LoggerManager.resolve(549),
      ...
      /*public*/ _reset: function() {
        streamLogger$8.logDebug(LoggerManager.resolve(550));
        this.point = -1;
      }
    };
...
var names$2 = {
  ...
  names$2 = Utils.getReverse(names$2); 
  ...
  var sessionLogger$3 = LoggerManager.getLoggerProxy(Constants.SESSION);
  var protocolLogger$3 = LoggerManager.getLoggerProxy(Constants.PROTOCOL);
  ...
  SessionHTTP.prototype = {
      ...
      /*public*/ createSession: function(oldSessionId,reconnectionCause,serverBusy) {
        if (!this._callSuperMethod(SessionHTTP,names$2['createSession'],[oldSessionId,reconnectionCause,serverBusy])) {
          return false;
        }
      ...
      /*protected*/ createSessionExecution: function(ph,reconnectionCause,oldSessionId) {
        ...
        if (Utils.isOffline()) {
          if (maybeOnline <= 0) {
            sessionLogger$3.logDebug(LoggerManager.resolve(551));
        ...
        if (done === null) {
         ...
         this.createSent();
          ...
          sessionLogger$3.logWarn(LoggerManager.resolve(552));
      ...
      /*public*/ bindSession: function(bindCause) {
        if (!this._callSuperMethod(SessionHTTP,names$2['bindSession'],[bindCause])) {
          return false;
        }
      ...
      /*public*/ recoverSession: function() {
          ...
          if (done === null) {
              ...
              sessionLogger$3.logError(LoggerManager.resolve(553));
              this.onErrorEvent("no_impl_available",{closedOnServer: true,noImplAvailable: true});
          }
      },
      
      shutdown: function(justSleep) {
        this._callSuperMethod(SessionHTTP,names$2['shutdown'],[justSleep]);
        if (this.activeConnection) {
          this.activeConnection._close();
        }
      },
...
//        protocolLogger.logDebug(LoggerManager.resolve(554),req);
      ...
      /*private*/ executeConnection: function(oldSession,retryMethod,reconnectionCause,sessionRecovery) {
        ...
        while ((this.chosenConnection || connList.hasNext()) && done === false) {
          ...
          if (done === null) {
            //try later...
            sessionLogger$3.logDebug(LoggerManager.resolve(555));
            ...
            //if (done === true)
            sessionLogger$3.logDebug(LoggerManager.resolve(556));
            connList._reset();
      ...
      /*protected*/ bindSent: function() {
        this._callSuperMethod(SessionHTTP,names$2['bindSent']);
      ...
      /*protected*/ onErrorEvent: function(reason, args) {
        ...
        this._callSuperMethod(SessionHTTP,names$2['onErrorEvent'],arguments);
      },
      ...
      /*private*/ onEvent: function() {
        ...
        this._callSuperMethod(SessionHTTP,names$2['onEvent']);
      },
...
var WS_OFF = 1;
  ...
  names$3 = Utils.getReverse(names$3); 
    
  
  var sessionLogger$4 = LoggerManager.getLoggerProxy(Constants.SESSION);
  
  var RECOVERY_SCHEDULED$1 = false;
  ...
  SessionWS.prototype = {
      ...
      //>>excludeStart("debugExclude", pragmas.debugExclude);  
        if (!ASSERT.verifyValue(this.wsPhase,WS_OFF)) {
          sessionLogger$4.logError(LoggerManager.resolve(557));
        }
      //>>excludeEnd("debugExclude");
        ...
        if (ConnectionSelector.isGood(_serverToUse,
            ...
            sessionLogger$4.logDebug(LoggerManager.resolve(558));
      ...
      /*public*/ createSent: function() {
        this._callSuperMethod(SessionWS,names$3['createSent']);
      ...
      /*public*/ bindSessionExecution: function(ph,bindCause) {
        ...
        if(this.wsPhase == WS_OFF) {
          ...
          if (!this.wsConn.isConnectedToServer(this.getPushServerAddress())) {
            sessionLogger$4.logWarn(LoggerManager.resolve(559));
            this.wsConn._close();
        ...
        //>>excludeStart("debugExclude", pragmas.debugExclude);  
          ASSERT.fail();
        //>>excludeEnd("debugExclude");
          sessionLogger$4.logError(LoggerManager.resolve(560),this);
        }
        
        
        if (done === null) {
          sessionLogger$4.logDebug(LoggerManager.resolve(561));
          Executor.addTimedTask(this.bindSessionExecution,50,this,[ph,bindCause]);
        } else if (done === false) {
          sessionLogger$4.logWarn(LoggerManager.resolve(562));
          this.onSessionGivesUp(this.handlerPhase,"ws.false");
        } else if (!firstSend) { 
          sessionLogger$4.logDebug(LoggerManager.resolve(563));
          this.bindSent();
      ...
      firstSentNotification: function(oPhase) {
        if (this.openWSPhase == oPhase) {
          sessionLogger$4.logDebug(LoggerManager.resolve(564));
          this.bindSent();
      ...
      /*private*/ onTimeout: function(timeoutType,ph,usedTimeout,coreCause,sessionRecovery) {
        ...
        this._callSuperMethod(SessionWS,names$3['onTimeout'],[timeoutType,ph,usedTimeout,coreCause,sessionRecovery]);
      },
  
      onLoop: function(serverSentPause) {
        this._callSuperMethod(SessionWS,names$3['onLoop'],[serverSentPause]);
      ...
      /*private*/ onStreamError: function(reason,toCheckPhase,fromWS,unableToOpen,possibleLoop) {
        if (fromWS) {
          ...
          if (toCheckPhase == this.openWSPhase) {
            ...
            this._callSuperMethod(SessionWS,names$3['onStreamError'],[reason,this.push_phase,fromWS,unableToOpen,possibleLoop]);
          }
        } else {
          if (this.phase == Session.CREATING) {
            this.forceEarlyWSOff = true;
          }
          this._callSuperMethod(SessionWS,names$3['onStreamError'],arguments);
        }
      },
      ...
      /*private*/ onStreamEnd: function(toCheckPhase,fromWS) {
        if (fromWS) {
          if (toCheckPhase == this.openWSPhase) {
            ...
            //>>excludeStart("debugExclude", pragmas.debugExclude);  
              if (!ASSERT.verifyDiffValue(this.phase,Session.FIRST_PAUSE)) {
                sessionLogger$4.logError(LoggerManager.resolve(565),this);
              }
            //>>excludeEnd("debugExclude"); 
              this._callSuperMethod(SessionWS,names$3['onStreamEnd'],[this.push_phase,fromWS]);
            }
          ...
          this._callSuperMethod(SessionWS,names$3['onStreamEnd'],arguments);
        }
      },
      ...
      /*protected*/ onErrorEvent: function(reason, args) {
        ...
        //>>excludeStart("debugExclude", pragmas.debugExclude);  
          if (!ASSERT.verifyDiffValue(this.wsPhase,WS_OFF)) {
            sessionLogger$4.logError(LoggerManager.resolve(566),this);
          }
        //>>excludeEnd("debugExclude"); 
          if (unableToOpen) {
          ...
          if (this.phase == Session.OFF || this.phase == Session.CREATING || this.phase ==  Session.CREATED) {
            ...
            //NOPPING!
            sessionLogger$4.logDebug(LoggerManager.resolve(567),this);
           
          } else if (this.phase == Session.FIRST_PAUSE) {
            //ws is now in control
            //so let's act now
            sessionLogger$4.logDebug(LoggerManager.resolve(568),this);
          ...
          //>>excludeStart("debugExclude", pragmas.debugExclude);  
            if (!ASSERT.verifyNotOk(unableToOpen)) {
              sessionLogger$4.logError(LoggerManager.resolve(569),this);
            }
          //>>excludeEnd("debugExclude");
            
            sessionLogger$4.logDebug(LoggerManager.resolve(570),this);
            this.closeSession(reason,closedOnServer,RECOVERY_SCHEDULED$1);
            this.onTimeout("zeroDelay",this.phaseCount,0,"ws.broken.wait");
                      
          } else {
            //classic case, we can use the default handling
            this._callSuperMethod(SessionWS,names$3['onErrorEvent'],arguments);
      ...
      /*public*/ shutdown: function(justSleep) {
        this._callSuperMethod(SessionWS,names$3['shutdown'],[justSleep]);
        if (this.wsConn) {
          this.openWSPhase = null;
          this.wsConn._close();
          this.wsConn = null;
      ...
      /*protected*/ onSessionGivesUp: function(ph,reason) {
           ...
           */
          WebSocketConnection.disableClass(this.getPushServerAddress());
          this._callSuperMethod(SessionWS,names$3['onSessionGivesUp'],[ph, reason]);
      },
      
      /**@override*/
      onSessionBound: function() {
          this._callSuperMethod(SessionWS,names$3['onSessionBound']);
...
//Coefficient of the moving average used to collect samples of delays.
  ...
  var protocolLogger$4 = LoggerManager.getLoggerProxy(Constants.PROTOCOL);
  var sessionLogger$5 = LoggerManager.getLoggerProxy(Constants.SESSION);
  ...
  SlowingHandler.prototype = {
    ...
    //>>excludeStart("debugExclude", pragmas.debugExclude);  
      if (!ASSERT.verifyOk(this.session.isReceivingAnswer())) {
        protocolLogger$4.logError(LoggerManager.resolve(571));
      }
    //>>excludeEnd("debugExclude");
  ...
  /////// leave the comment to trigger the heuristic: //////////////////////////////////////////////////////////////////////////
      ...
      if (this.meanElaborationDelay == null) {
        ...
        sessionLogger$5.logDebug(LoggerManager.resolve(572));
        ...
        if (diffTime > hugeDelay && diffTime > this.meanElaborationDelay*2) {
          ...
          if (this.hugeFlag) {
            sessionLogger$5.logInfo(LoggerManager.resolve(573));
        ...
        if (this.meanElaborationDelay < 60) { //the executer runs every 50ms, we can forgive such delay
          ...
          sessionLogger$5.logDebug(LoggerManager.resolve(574));
          return false;
              
        } else if (this.isLate(maxMean)) {
          // things are going bad
          sessionLogger$5.logInfo(LoggerManager.resolve(575));
          return true;
            
        } else {
          sessionLogger$5.logDebug(LoggerManager.resolve(576));
          return false;
...
var requestsLogger$1 = LoggerManager.getLoggerProxy(Constants.REQUESTS);
  ...
  ControlRequestBatch.prototype = {
              ...
              if (seq != null && prog != null) {
                  for (var i = 0, len = that.queue.length - 1 /* exclude last request */; i < len; i++) {
                      ...
                      if (seq == currentSeq && prog == currentProg) {
                          if (requestsLogger$1.isDebugLogEnabled()) {
                              requestsLogger$1.logErrorExc(new Error("backtrace"),
                                      "Duplicated message",
                                      "seq=", seq, "prog=", prog, "ptr=", request === currentReq);
                          }
                          requestsLogger$1.logError(LoggerManager.resolve(577), "seq=", seq, "prog=", prog);
                      }
                  }
              }
          }
    ...
    addRequestToBatch:function(request,preventOverride) {
      ...
      if (requestType == ControlRequest.MESSAGE || requestType == ControlRequest.LOG || requestType == ControlRequest.HEARTBEAT) {
        ...
        //>>excludeStart("debugExclude", pragmas.debugExclude);  
          ASSERT.fail();
        //>>excludeEnd("debugExclude");
          requestsLogger$1.logError(LoggerManager.resolve(578),this);
      ...
      //>>excludeStart("debugExclude", pragmas.debugExclude);  
        ASSERT.fail();
      //>>excludeEnd("debugExclude");
        requestsLogger$1.logError(LoggerManager.resolve(579),this);
        //should I send an exception?
        return false;
      }
      ...
      requestsLogger$1.logDebug(LoggerManager.resolve(580),this,tKey,request);
      ...
      if (queuedRequest) {
        ...
        if (requestType == ControlRequest.CONSTRAINT 
          ...
          if (!preventOverride) {
            requestsLogger$1.logDebug(LoggerManager.resolve(581));
          ...
          if (queuedRequest.retryingOrHost) {
            requestsLogger$1.logDebug(LoggerManager.resolve(582));
            ...
            requestsLogger$1.logDebug(LoggerManager.resolve(583));
            ...
            requestsLogger$1.logDebug(LoggerManager.resolve(584));
          ...
          //>>excludeStart("debugExclude", pragmas.debugExclude);  
            if (!ASSERT.verifyNotOk(preventOverride)) {
              requestsLogger$1.logError(LoggerManager.resolve(585),this);
            }
          //>>excludeEnd("debugExclude");
            if (!preventOverride) {
          ...
          while (queuedRequest && request.retryingOrHost != queuedRequest.retryingOrHost) {
            requestsLogger$1.logDebug(LoggerManager.resolve(586));
            tKey += "_";
            queuedRequest = this.keys[tKey];
          }
          
          if (queuedRequest) {
            requestsLogger$1.logDebug(LoggerManager.resolve(587));
            return;
          }
          ...
          if (!preventOverride) {
              requestsLogger$1.logDebug(LoggerManager.resolve(588));
      ...
      requestsLogger$1.logDebug(LoggerManager.resolve(589));
      this.addRequestInternal(tKey,request);
    ...
    /*private*/ removeRequestByIndex: function(_index) {
      if (this.queue.length <= _index) {
        requestsLogger$1.logError(LoggerManager.resolve(590));
        return null;
      }
    ...
    /*private*/ removeRequestByKey: function(tKey) {
      if (!this.keys[tKey]) {
        requestsLogger$1.logError(LoggerManager.resolve(591));
        return null;
      }
...
var requestsLogger$2 = LoggerManager.getLoggerProxy(Constants.REQUESTS);
  var streamLogger$9 = LoggerManager.getLoggerProxy(Constants.STREAM);
...
//>>excludeEnd("debugExclude");
  ...
  ControlConnectionHandler.prototype = {
    ...
    /*public*/ setRequestLimit: function(newLimit) {
      ...
      requestsLogger$2.logDebug(LoggerManager.resolve(592),this);
    },
    ...
    /*public*/ startReverseHeartbeats: function(newInterval, force) {
      if (force) {
          ...
          requestsLogger$2.logInfo(LoggerManager.resolve(593),this);
      } else {
          if (this.grantedReverseHeartbeatInterval == 0 || newInterval < this.grantedReverseHeartbeatInterval) {
              this.currentReverseHeartbeatInterval = newInterval;
              requestsLogger$2.logInfo(LoggerManager.resolve(594),this);
          } else {
              this.currentReverseHeartbeatInterval = this.grantedReverseHeartbeatInterval;
              requestsLogger$2.logInfo(LoggerManager.resolve(595),this);
          }
      }
    ...
    sendReverseHeartbeat: function(sc) {
      ...
      requestsLogger$2.logDebug(LoggerManager.resolve(596),this);
    ...
    /*public*/ stopReverseHeartbeats: function(force) {
      if (force) {
          requestsLogger$2.logInfo(LoggerManager.resolve(597),this);
          this.currentReverseHeartbeatInterval = 0;
          this.grantedReverseHeartbeatInterval = 0;
          //do nothing, the next heartbeat will not be sent because of the 0 interval
      } else {
          if (this.grantedReverseHeartbeatInterval == 0) {
              requestsLogger$2.logInfo(LoggerManager.resolve(598),this);
              this.currentReverseHeartbeatInterval = 0;
              //do nothing, the next heartbeat will not be sent because of the 0 interval
          } else {
              requestsLogger$2.logInfo(LoggerManager.resolve(599),this);
              this.currentReverseHeartbeatInterval = this.grantedReverseHeartbeatInterval;
          }
      }
    },
    ...
    /*private*/ _close: function() {
      requestsLogger$2.logDebug(LoggerManager.resolve(600));
      if (this.conn) {
        this.conn._close();
      }
    },
    ...
    /*private*/ changeStatus: function(newStatus, caller) {
      ...
      if (requestsLogger$2.isDebugLogEnabled()) {          
          requestsLogger$2.logDebug(LoggerManager.resolve(601), caller + phNames[this.status] + " -> " + phNames[newStatus]);
      }
      this.status = newStatus;
    },

    /*public*/ _reset: function() {
      requestsLogger$2.logDebug(LoggerManager.resolve(602),this);
      this.requestLimit = 0;
      ...
      if (_type !== null && _type !== ControlRequest.DESTROY && _type !== ControlRequest.LOG) {  
        ...
        if (!ASSERT.verifyDiffValue(this.status,_IDLE)) {
          requestsLogger$2.logError(LoggerManager.resolve(603));
        }
        //>>excludeEnd("debugExclude");         
        ...
        if (!ASSERT.verifyValue(this.status,_IDLE)) {
          requestsLogger$2.logError(LoggerManager.resolve(604));
        }
        
        //nothing to close
        //lastBatch is already null
        if (!ASSERT.verifyValue(this.lastBatch,null)) {
          requestsLogger$2.logError(LoggerManager.resolve(605));
        }
      //>>excludeEnd("debugExclude");  
    ...
    assignWS: function(wsConn) {
      ...
      if (wsConn) {
        requestsLogger$2.logDebug(LoggerManager.resolve(606),this);
      } else if (this.wsConn) {
        requestsLogger$2.logDebug(LoggerManager.resolve(607),this);
      }
    ...
    /*private*/ addRequestExe: function(ph, num, request, _type, related, retryingOrHost) {
      ...
      requestsLogger$2.logInfo(LoggerManager.resolve(608),this,request);
      ...
      if (this.status == _IDLE) {
        ...
        requestsLogger$2.logDebug(LoggerManager.resolve(609),this);
      }
    ...
    /*private*/ dequeue: function(sync,who) {
      if (sync === true) {
        requestsLogger$2.logDebug(LoggerManager.resolve(610),sync,this);
        this.dequeueControlRequests(this.statusPhase,who);
        
      } else {
        requestsLogger$2.logDebug(LoggerManager.resolve(611),sync,this);
    ...
    /*private*/ dequeueControlRequests: function(ph,who) {
      ...
      while(security < SECURITY_LIMIT) {
        ...
        requestsLogger$2.logDebug(LoggerManager.resolve(612),who,this);
        
        var outcome = null;
        if (this.lastBatch != null) {
          requestsLogger$2.logDebug(LoggerManager.resolve(613));
          outcome = this.sendBatch(this.lastBatch);
        } else {
          requestsLogger$2.logDebug(LoggerManager.resolve(614));
          outcome = this.selectAndSendBatch();
        }
        
        if (outcome == REQ_EMPTY) {
          requestsLogger$2.logInfo(LoggerManager.resolve(615));
          ...
          requestsLogger$2.logInfo(LoggerManager.resolve(616));
          //will try to send lastBatch
          this.dequeue(WAIT_CONN_DELAY,"later");
          return;
          
        } else if (outcome == NO_CONN) {
          requestsLogger$2.logWarn(LoggerManager.resolve(617));
          ...
          requestsLogger$2.logInfo(LoggerManager.resolve(618));
          ...
          requestsLogger$2.logInfo(LoggerManager.resolve(619));
          ...
          requestsLogger$2.logInfo(LoggerManager.resolve(620));
    ...
    /*private*/ sendBatch: function(queueToSend) {
              ...
              for (var i = 0, ilen = queueToSend.queue.length; i < ilen; i++) {
                  ...
                  if (seq != null && prog != null) {
                      for (var j = i + 1, jlen = queueToSend.queue.length; j < jlen; j++) {
                          ...
                          if (seq == currentSeq && prog == currentProg) {
                              if (requestsLogger$2.isDebugLogEnabled()) {
                                  requestsLogger$2.logErrorExc(new Error("backtrace"),
                                          "Duplicated message",
                                          "seq=", seq, "prog=", prog, "ptr=", request === currentReq);
                              }
                              requestsLogger$2.logError(LoggerManager.resolve(621), "seq=", seq, "prog=", prog);
                          }
                      }
                  }
              }
      ...
      if (mainRequest == null) {
        requestsLogger$2.logDebug(LoggerManager.resolve(622));
        return REQ_EMPTY;
      }
      
      requestsLogger$2.logDebug(LoggerManager.resolve(623));
...
//////////////////////////////WS CASE      
      ...
      if (this.wsConn) {
        requestsLogger$2.logDebug(LoggerManager.resolve(624));
        
        var controlRequest = this.customizeRequest(queueToSend,this.wsConn);
        if(controlRequest == null) {
          requestsLogger$2.logDebug(LoggerManager.resolve(625));
          return REQ_EMPTY;
        }
...
//            ASSERT.fail(); //no reason to be here, we have a session id so there should be at least one working connection
          //>>excludeEnd("debugExclude");  
            requestsLogger$2.logWarn(LoggerManager.resolve(626),this.conn);
          ...
          requestsLogger$2.logDebug(LoggerManager.resolve(627),this.conn);
        }      
        
        var controlRequest = this.customizeRequest(queueToSend,this.conn);
        if(controlRequest == null) {
          requestsLogger$2.logDebug(LoggerManager.resolve(628));
          return REQ_EMPTY;
        }
...
//>>excludeEnd("debugExclude");
        ...
        if (sent === false) {
          requestsLogger$2.logDebug(LoggerManager.resolve(629));
          this.conn = null;
          
        } else if (sent === null) {
          requestsLogger$2.logDebug(LoggerManager.resolve(630));
          //wait and try again
          return SEND_LATER;
...
//////////////////////////////???? CASE 
      ...
      //>>excludeStart("debugExclude", pragmas.debugExclude);  
        ASSERT.fail();
      //>>excludeEnd("debugExclude");
        requestsLogger$2.logError(LoggerManager.resolve(631));
      }
    ...
    /*private*/ onReadyForNextRequest: function(_responseText,sentPhase) {
      ...
      if (streamLogger$9.isDebugLogEnabled()) {
          streamLogger$9.logDebug(LoggerManager.resolve(632), sentPhase, _responseText);          
      }
      requestsLogger$2.logInfo(LoggerManager.resolve(633),sentPhase);
    ...
    /*private*/ onErrorEvent: function(exc,sentPhase) {
      ...
      requestsLogger$2.logInfo(LoggerManager.resolve(634),this,exc);
  ...
  LastBatch.prototype = {
      ...
      fill: function(queue,lengthLimit,sessionId,cookieHandlingRequired,extraHeaders) {
        ...
        if (lengthLimit > 0 && (nextExpectedLength+expectedFinalLength) > lengthLimit) {
          requestsLogger$2.logWarn(LoggerManager.resolve(635),requestData);
        }
...
var notifySenderName$1;
  for(var i$3 in  {notifySender:true}) {
    notifySenderName$1=i$3;
  }
  ...
  SendMessageBridge.prototype = {
    ...
    /*public*/ notifySender: function(failed) {
      this._callSuperMethod(SendMessageBridge,notifySenderName$1,[failed]);
...
var messagesLogger = LoggerManager.getLoggerProxy(Constants.MESSAGES);
  ...
  SendMessageHandler.prototype = {
    ...
    /*public*/ _close: function() {
      ...
      this.messagePhase++;
      messagesLogger.logDebug(LoggerManager.resolve(636));
    },
    
    /*public*/ activate: function() {
      messagesLogger.logDebug(LoggerManager.resolve(637));
      if (! this.active) {
    ...
    _send: function(_message, sequence, listener, _timeout) {
      messagesLogger.logDebug(LoggerManager.resolve(638));
      ...
      if (this.active) {
        messagesLogger.logInfo(LoggerManager.resolve(639),query);
    ...
    /*public*/ resend: function(num,bridge) {
      ...
      messagesLogger.logDebug(LoggerManager.resolve(640),query);
    ...
    /*public*/ ack: function(sequence, num) {
      ...
      messagesLogger.logInfo(LoggerManager.resolve(641),sequence,num);
      
      var seqData = this.sequences[sequence];
      if (seqData.messages[num]) {
        if (seqData.messages[num].query != null) {
          messagesLogger.logDebug(LoggerManager.resolve(642));
          seqData.messages[num].query = null;
        }
        if (seqData.messages[num].listener == null) {
          messagesLogger.logDebug(LoggerManager.resolve(643));
    ...
    /*public*/ noAckMessageSent: function(sequence, num) {
      messagesLogger.logDebug(LoggerManager.resolve(644),sequence,num);
      this._clear(sequence, num);
    },
    
    /*private*/ _clear: function(sequence, num) {
      //this method is always called with the actual num
      messagesLogger.logDebug(LoggerManager.resolve(645));
      var seqData = this.sequences[sequence];
    ...
    sentOnNetwork: function(sequence, num) {
      messagesLogger.logDebug(LoggerManager.resolve(646),sequence, num);
    ...
    /*public*/ _complete: function(sequence, num) {
      num = sequence == Constants._UNORDERED_MESSAGES ? this.resolveUnorderedNum(num) : num;
      messagesLogger.logInfo(LoggerManager.resolve(647),sequence, num);
      var listenerInfo = this.getListener(sequence, num);
      if(listenerInfo) {
    ...
    /*public*/ notifyDiscarded: function(sequence,num) {
      num = sequence == Constants._UNORDERED_MESSAGES ? this.resolveUnorderedNum(num) : num;
      messagesLogger.logInfo(LoggerManager.resolve(648),sequence, num);
    ...
    /*public*/ notifyDenied: function(sequence,_code,msg,num) {
      num = sequence == Constants._UNORDERED_MESSAGES ? this.resolveUnorderedNum(num) : num;
      messagesLogger.logInfo(LoggerManager.resolve(649),sequence, num);
      var listenerInfo = this.getListener(sequence, num);
      if(listenerInfo) {
        var ppHandler = this.pushPagesHandler.getPushPageHandler(listenerInfo.pageNum);
        if (ppHandler) {
    ...
    /*public*/ notifyError: function(sequence,_code,msg,num) {
      num = sequence == Constants._UNORDERED_MESSAGES ? this.resolveUnorderedNum(num) : num;
      messagesLogger.logInfo(LoggerManager.resolve(650),sequence, num);
      var listenerInfo = this.getListener(sequence, num);
      if(listenerInfo) {
 ...
 */
     ...
     */
    var EncodingUtils = {unquote: decodeURIComponent};
...
var streamLogger$a = LoggerManager.getLoggerProxy(Constants.STREAM);
  ...
  var EvalQueue = function(engId) {
    ...
    this["lsc"] = {};
    this["lsc"]["LS_window"] = Lightstreamer["_"+engId];
  ...
  EvalQueue.prototype = {
    ...
    /*public*/ _enqueue: function(_phase,_data) {
      ...
      if (streamLogger$a.isDebugLogEnabled()) {
        streamLogger$a.logDebug(LoggerManager.resolve(651));
      }
    ...
    */
    /*private*/ dequeueAll: function() {
      ...
      if(streamLogger$a.isDebugLogEnabled()) {
        streamLogger$a.logDebug(LoggerManager.resolve(652),this.equeue.length);
      }
      ...
      while (this.equeue.length > 0) {
        ...
        if (!this.session || !this.session.checkSessionPhase(_el.p)) {
          streamLogger$a.logWarn(LoggerManager.resolve(653), _el.p, _el.d, this.session);
          continue;
        }
        ...
        //>>excludeStart("debugExclude", pragmas.debugExclude);   
          console.log(_e);
        //>>excludeEnd("debugExclude");
          streamLogger$a.logError(LoggerManager.resolve(654),_e,_el.d);
    ...
    parseText: function(text) {
        ...
        for (var i = 0; i < lines.length; i++) {
            ...
            try {
                ...
                streamLogger$a.logError(LoggerManager.resolve(655), line, e);
    ...
    processUpdate: function(msg) {
        ...
        try {
            ...
            streamLogger$a.logError(LoggerManager.resolve(656), e);
        }
    },
...
var _OFF$1 = 1;
  ...
  var protocolLogger$5 = LoggerManager.getLoggerProxy(Constants.PROTOCOL);
  var sessionLogger$6 = LoggerManager.getLoggerProxy(Constants.SESSION);
  
  var objectIdCounter$3 = 1;
  
  var SessionHandler = function(owner,ppHandler,mpnManager) {
    this.objectId = objectIdCounter$3++;
    if (sessionLogger$6.isDebugLogEnabled()) {
        sessionLogger$6.logDebug(LoggerManager.resolve(657), this.objectId);
    }
    this.status = _OFF$1;
    this.statusPhase = 0;
    this.session = null;
  ...
  SessionHandler.prototype = {
      ...
      /*private*/ exportForceReload: function() {
        ...
        Lightstreamer.exportGlobal(this.engineId,"LS_forceReload",function() {
          if (that.session) {
      ...
      /*private*/ changeStatus: function(newStatus) {
        if (sessionLogger$6.isDebugLogEnabled()) {
            sessionLogger$6.logDebug(LoggerManager.resolve(658), toStr(this.status), "->", toStr(newStatus));
        }
        this.status = newStatus;
        this.statusPhase++;
      },
...
////////////////////////////////////////////////API CALLS
      ...
      /*public*/ closeSession: function(fromAPI,reason,noRecoveryScheduled) {
        if (this.status == _OFF$1 || this.status == END) {
          return;
        }
      ...
      /*private*/ isAlive: function() {
        return this.status != _OFF$1 && this.status != END;
      },
      ...
      /*public*/ recoverSession: function(ph,switchCause,forced) {
          sessionLogger$6.logDebug(LoggerManager.resolve(659), switchCause);
          if (ph != this.statusPhase) {
              sessionLogger$6.logDebug(LoggerManager.resolve(660));
              return;
          }
      ...
      onSessionGivesUp: function(ph,reason,stop) {
        if (ph != this.statusPhase) {
          ...
          sessionLogger$6.logInfo(LoggerManager.resolve(661));
          
          this.changeStatus(_OFF$1);
          return;
        }
        ...
        sessionLogger$6.logInfo(LoggerManager.resolve(662), toStr(this.status),toStr(switchType));
        
        if (switchType == _OFF$1 || switchType == END) {
        //>>excludeStart("debugExclude", pragmas.debugExclude);  
          ASSERT.fail();
        //>>excludeEnd("debugExclude");
          sessionLogger$6.logError(LoggerManager.resolve(663));
          return;
        }
      ...
      onSlowRequired: function(ph) {
        ...
        sessionLogger$6.logInfo(LoggerManager.resolve(664), toStr(this.status),toStr(switchType));
        
        if(!switchType) {
        //>>excludeStart("debugExclude", pragmas.debugExclude);  
          ASSERT.fail();
        //>>excludeEnd("debugExclude");
          sessionLogger$6.logError(LoggerManager.resolve(665), toStr(this.status), this.session);
          return;
        }
        this.changeStatus(switchType);
      ...
      createMachine: function(ph,switchCause,forced) {
        ...
        sessionLogger$6.logInfo(LoggerManager.resolve(666), toStr(this.status),toStr(switchType));
        
        if (switchType == _OFF$1 || switchType == END) {
        //>>excludeStart("debugExclude", pragmas.debugExclude);  
          ASSERT.fail();
        //>>excludeEnd("debugExclude");
          sessionLogger$6.logError(LoggerManager.resolve(667));
          return;
        }
      ...
      switchMachine: function(ph,switchCause,forced) {
        ...
        sessionLogger$6.logInfo(LoggerManager.resolve(668), toStr(this.status));
        
        if (!SWITCHING_STATUSES[switchType]) {
        //>>excludeStart("debugExclude", pragmas.debugExclude);  
          ASSERT.fail();
        //>>excludeEnd("debugExclude");
          sessionLogger$6.logError(LoggerManager.resolve(669));
          return;
        }
      ...
      slowMachine: function(ph) {
        sessionLogger$6.logInfo(LoggerManager.resolve(670));
      ...
      switchTimeout: function(ph,reason) {
        ...
        sessionLogger$6.logInfo(LoggerManager.resolve(671), toStr(this.status));
        
        if (!SWITCHING_STATUSES[switchType]) {
        //>>excludeStart("debugExclude", pragmas.debugExclude);  
          ASSERT.fail();
        //>>excludeEnd("debugExclude");
          sessionLogger$6.logError(LoggerManager.resolve(672));
          return;
        }
...
////////////////////////////////////////////////PUSH EVENTS 
      ...
      /*public*/ onSessionStart: function(requestLimitLength) {
        sessionLogger$6.logInfo(LoggerManager.resolve(673),this.session);
      ...
      /*public*/ onSessionClose: function(ph,noRecoveryScheduled) {
        ...
        sessionLogger$6.logDebug(LoggerManager.resolve(674),this.session);
      ...
      /*public*/ onUpdateReceived: function(args,snap) {
        ...
        if (!ppHandler) {
          protocolLogger$5.logDebug(LoggerManager.resolve(675),this);
          return;
        }
        
        if (protocolLogger$5.isDebugLogEnabled()) {
          protocolLogger$5.logDebug(LoggerManager.resolve(676),args);
        }
      ...
      /*public*/ onLostUpdatesEvent: function(args) {
        ...
        if (!ppHandler) {
          ...
          protocolLogger$5.logDebug(LoggerManager.resolve(677),this);
          return;
        }
        
        if (protocolLogger$5.isDebugLogEnabled()) {
          protocolLogger$5.logDebug(LoggerManager.resolve(678),args);
        }
      ...
      /*public*/ onEndOfSnapshotEvent: function(args) {
        ...
        if (!ppHandler) {
          //we used to call the deletes here, but when a page disappears its delete are 
          //automatically sent so we can just return
          protocolLogger$5.logDebug(LoggerManager.resolve(679),this);
          return;
        }
        
        if (protocolLogger$5.isDebugLogEnabled()) {
          protocolLogger$5.logDebug(LoggerManager.resolve(680),args);
        }
      ...
      /*public*/ onClearSnapshotEvent: function(args) {
        ...
        if (!ppHandler) {
          //we used to call the deletes here, but when a page disappears its delete are 
          //automatically sent so we can just return
          protocolLogger$5.logDebug(LoggerManager.resolve(681),this);
          return;
        }
        
        if (protocolLogger$5.isDebugLogEnabled()) {
          protocolLogger$5.logDebug(LoggerManager.resolve(682),args);
        }
      ...
      /*public*/ onServerError: function(flag,msg) {
        if (protocolLogger$5.isDebugLogEnabled()) {
          protocolLogger$5.logDebug(LoggerManager.resolve(683),flag,msg);
        }
        this.changeStatus(_OFF$1);
      ...
      /*public*/ onTableError: function(tableCode,flag,msg) {
        ...
        if (ppHandler) {
          if (protocolLogger$5.isDebugLogEnabled()) {
            protocolLogger$5.logDebug(LoggerManager.resolve(684),tableCode,flag,msg);
          }
          ppHandler.onSubscriptionError(tableCode,flag,msg);
        } else {
          //we used to call the deletes here, but when a page disappears its delete are
          //automatically sent so we can just return
          protocolLogger$5.logDebug(LoggerManager.resolve(685),this);
        }
      ...
      /*public*/ onUnsubscription: function(tableCode) {
        ...
        if (ppHandler) {
          if (protocolLogger$5.isDebugLogEnabled()) {
            protocolLogger$5.logDebug(LoggerManager.resolve(686),tableCode);
          }
          ...
          //we used to call the deletes here, but when a page disappears its delete are
          //automatically sent so we can just return
          protocolLogger$5.logDebug(LoggerManager.resolve(687),this);
        }
      ...
      /*public*/ onSubscriptionReconf: function(tableCode,ph,frequency) {
        if (protocolLogger$5.isDebugLogEnabled()) {
          protocolLogger$5.logDebug(LoggerManager.resolve(688),tableCode,ph,frequency);
        }
        ...
        if (ppHandler != null) {
            ...
            protocolLogger$5.logWarn(LoggerManager.resolve(689), tableCode);
        }
      },
      ...
      /*public*/ onSubscription: function(tableCode,numOfSubscribedItems,numOfSubscribedFields,keyPos,commandPos) {
        ...
        if (!ppHandler) {
          //we used to call the deletes here, but when a page disappears its delete are
          //automatically sent so we can just return
          protocolLogger$5.logDebug(LoggerManager.resolve(690),this);
          return;
        }

        if (protocolLogger$5.isDebugLogEnabled()) {
          protocolLogger$5.logDebug(LoggerManager.resolve(691),tableCode,numOfSubscribedItems,numOfSubscribedFields,keyPos,commandPos);
        }
      ...
      /*public*/ onMessageAck: function(sequence,num) {
        if (protocolLogger$5.isDebugLogEnabled()) {
          protocolLogger$5.logDebug(LoggerManager.resolve(692),sequence,num);
        }
      ...
      onMessageOk: function(sequence,num) {
        if (protocolLogger$5.isDebugLogEnabled()) {
          protocolLogger$5.logDebug(LoggerManager.resolve(693),sequence,num);
        }
      ...
      onMessageDeny: function(sequence,flag,msg,num) {
        if (protocolLogger$5.isDebugLogEnabled()) {
          protocolLogger$5.logDebug(LoggerManager.resolve(694),sequence,num,flag,msg);
        }
      ...
      /*public*/ onMessageDiscarded: function(sequence,num) {
        if (protocolLogger$5.isDebugLogEnabled()) {
          protocolLogger$5.logDebug(LoggerManager.resolve(695),sequence,num);
        }
      ...
      /*public*/ onMessageError: function(sequence,flag,msg,num) {
        if (protocolLogger$5.isDebugLogEnabled()) {
          protocolLogger$5.logDebug(LoggerManager.resolve(696),sequence,num,flag,msg);
        }
      ...
      onNewControlLink: function(serverAddress) {
        if (protocolLogger$5.isDebugLogEnabled()) {
          protocolLogger$5.logDebug(LoggerManager.resolve(697),serverAddress);
        }
...
////////////////////////////////////////////////CONTROLS
      ...
      /*public*/ sendUnsubscription: function(tableNum,delBody,ppHandler,retrying,tutor) {
          var requestListener = {
                  ...
                  onREQERR: function(LS_window, phase, errorCode, errorMsg) {
                      tutor.discard();
                      sessionLogger$6.logError(LoggerManager.resolve(698) + printObj$1(delBody) + " caused the error: ", errorCode, errorMsg);
                  }
          };
      ...
      /*public*/ sendSubscriptionChange: function(tableNum,changeBody,tutor) {
          var requestListener = {
                  ...
                  onREQERR: function(LS_window, phase, errorCode, errorMsg) {
                      tutor.discard();
                      sessionLogger$6.logError(LoggerManager.resolve(699) + printObj$1(changeBody) + "] caused the error: " + errorCode + " " + errorMsg);
                  }
          };
      ...
      onFatalError: function(error) {
          sessionLogger$6.logError(LoggerManager.resolve(700), error.stack || error);
          if (this.session) {
...
var simple$1 = CallDefinition.simple;
  //var simpleWithResponse = CallDefinition.simpleWithResponse;
  var simpleWithResponseAndTimeout$1 = CallDefinition.simpleWithResponseAndTimeout;

  var methods$1 = {
    onEngineConfigurationChange: simple$1,
    onEngineDeath: simple$1,
    onStatusChange: simple$1,
    onSessionStart: simple$1,
    onSessionEnd: simple$1,
    onEngineDying: simple$1,
    onServerError: simple$1,
    onServerKeepalive: simple$1,
    ping: simpleWithResponseAndTimeout$1,
    onSubscription: simple$1,
    onUnsubscription: simple$1,
    onEndOfSnapshot: simple$1,
    onUpdate: simple$1,
    onLostUpdates: simple$1,
    onClearSnapshot: simple$1,
    onSubscriptionError: simple$1,
    onMessageDiscarded: simple$1,
    onMessageDenied: simple$1,
    onMessageError: simple$1,
    onMessageComplete: simple$1,
    onMessageOnNetwork: simple$1,
    onSubscriptionReconf: simple$1
  };
  ...
  NewPushPageHandler.methods = methods$1;
...
//calls from engine handler
  ...
  for (var i$4 in methods$1) {
    NewPushPageHandler.prototype[i$4] = StandardHandler.createCaller(i$4,methods$1[i$4]);
  }
...
//THIS CLASS IMPLEMENTS BeanParent
  ...
  var sessionLogger$7 = LoggerManager.getLoggerProxy(Constants.SESSION);
  ...
  var LightstreamerEngine = function(conf,options,details,sharing,engineHandler,dontDieFor,mpnManager) {
    ...
    if (sharing && sharing.isPossible()) {
      ...
      do {
        this.id = "NS" + (idPivot++);
      } while(Lightstreamer.hasGlobal(this.id,'lsEngine'));
    }

    Lightstreamer.exportGlobal(this.id,'lsEngine',this);
  ...
  LightstreamerEngine.prototype = {
    ...
    dispose: function() {
      ...
      Lightstreamer.cleanAllGlobals(this.id); //no one should be able to find me now
    ...
    doDisconnect: function() {
      sessionLogger$7.logInfo(LoggerManager.resolve(701));
    ...
    doChangeTransport: function() {
        ...
        sessionLogger$7.logInfo(LoggerManager.resolve(702), ft);
        if (ft === null) {
            var fromAPI = true;
    ...
    doConnect: function() {
      sessionLogger$7.logInfo(LoggerManager.resolve(703));
...
var actionsLogger$1 = LoggerManager.getLoggerProxy(Constants.ACTIONS);
       ...
       forEachChangedField: function(iterator) {
         ...
         for (var i = 0; i < ch.length; i++) {
           ...
           try {
             ...
             actionsLogger$1.logErrorExc(_e,LoggerManager.resolve(704));
           }
       ...
       forEachField: function(iterator) {
         for (var i = 2; i < this.updateValues.length; i++) {
           ...
           try {
             ...
             actionsLogger$1.logErrorExc(_e,LoggerManager.resolve(705));
           }
...
//table status events    
    ...
    cleanData: function() {
      ...
      subscriptionsLogger.logDebug(LoggerManager.resolve(706),this);
    },
    ...
    //>>excludeEnd("debugExclude");
      ...
      subscriptionsLogger.logInfo(LoggerManager.resolve(707),this);
    ...
    onSubmission: function() {
      ...
      subscriptionsLogger.logDebug(LoggerManager.resolve(708),this);
    },
    ...
    onTableNumber: function(tableNum) {
          ...
          subscriptionsLogger.logDebug(LoggerManager.resolve(709),this);        
    },
    ...
    onPause: function() {
      ...
      subscriptionsLogger.logDebug(LoggerManager.resolve(710),this);
    },
    ...
    //>>excludeEnd("debugExclude");
      ...
      subscriptionsLogger.logDebug(LoggerManager.resolve(711),this);
    ...
    //>>excludeEnd("debugExclude");
      subscriptionsLogger.logInfo(LoggerManager.resolve(712),this);
    ...
    //>>excludeEnd("debugExclude");
      subscriptionsLogger.logInfo(LoggerManager.resolve(713),this);
    ...
    /*private*/ generateRequest: function() {
      ...
      subscriptionsLogger.logDebug(LoggerManager.resolve(714),this);
    ...
    setServerSentMetapushFields: function(commandPos, keyPos) {
      subscriptionsLogger.logDebug(LoggerManager.resolve(715),this,commandPos,keyPos);
...
//////////////////phases, see https://docs.google.com/a/lightstreamer.com/drawings/d/1SsbEMF78re0ASAgByUhy5EQeKWjTG9FUkGR4zMGhtSc/edit?hl=en_US
    ...
    setDataAdapter: function(dataAdapter) {
      ...
      subscriptionsLogger.logDebug(LoggerManager.resolve(716),this,dataAdapter);
    },
    ...
    setSelector: function(selector) {
      ...
      subscriptionsLogger.logDebug(LoggerManager.resolve(717),this,selector);
    },
    ...
    setRequestedMaxFrequency: function(freq) {
      ...
      subscriptionsLogger.logDebug(LoggerManager.resolve(718),this,this.requestedMaxFrequency);
    },
    ...
    setRequestedBufferSize: function(size) {
      ...
      subscriptionsLogger.logDebug(LoggerManager.resolve(719),this,this.requestedBufferSize);
    },
    ...
    setRequestedSnapshot: function(required) {
      ...
      subscriptionsLogger.logDebug(LoggerManager.resolve(720),this,this.isRequiredSnapshot);
    },
    ...
    setCommandSecondLevelDataAdapter: function(dataAdapter) {
      ...
      subscriptionsLogger.logDebug(LoggerManager.resolve(721),this,dataAdapter);
    },
...
/////////////METAPUSH    
    ...
    organizeMPUpdate: function(args,_item,fromMultison) {
      ...
      if ((typeof args[this.keyCode + 1] == "undefined")||(typeof args[this.commandCode + 1] == "undefined")) {
        subscriptionsLogger.logWarn(LoggerManager.resolve(722));
        return null;
      }
...
var LightstreamerClient = /*@__PURE__*/(function() {
  //THIS CLASS IMPLEMENTS BeanParent
...
// END_NODE_JSDOC_EXCLUDE
      enableSharing: function(sharing) {
        ...
        if (userAgent != null && (userAgent.indexOf("ucbrowser") != -1 || userAgent.indexOf("ubrowser") != -1)) {
            sharingLogger.logInfo(LoggerManager.resolve(723));
            return;
        }
      ...
      enableSharingExec: function(sharing,ph) {
        ...
        if (sharing && ! sharing.isPossible()) {
            sharingLogger.logInfo(LoggerManager.resolve(724));
        }
        if (sharing && sharing.isPossible()) {
      ...
      engineMourningRoom: function(suicided, noHopeToAttachToAnotherEngine) {
        ...
        if (EnvironmentStatus.isUnloading() || EnvironmentStatus.isUnloaded()) {
          actionsLogger.logInfo(LoggerManager.resolve(725));
          return;
        }
...
//>>excludeStart("debugExclude", pragmas.debugExclude);
        if (!this.sharing) {
          ASSERT.fail();
          actionsLogger.logError(LoggerManager.resolve(726));
          return;
        }
//>>excludeEnd("debugExclude");

        actionsLogger.logInfo(LoggerManager.resolve(727));
        ...
        if (this._configuration.clientsCount <= 2) ; else if (suicided) {
...
END_NODE_JSDOC_EXCLUDE
      ...
      connect: function() {
        ...
        actionsLogger.logInfo(LoggerManager.resolve(728));
      ...
      asynchConnect: function() {
        ...
        actionsLogger.logDebug(LoggerManager.resolve(729));
...
END_NODE_JSDOC_EXCLUDE
       ...
       */
      disconnect: function() {
        actionsLogger.logInfo(LoggerManager.resolve(730));
      ...
      asynchDisconnect: function() {
        ...
        actionsLogger.logDebug(LoggerManager.resolve(731));
...
/*
  ...
  limitations under the License.
*/
var SimpleLogLevels = /*@__PURE__*/(function() {
  /**
   * @private
   */
  var logLevel = {
...
var SimpleLogAppender = /*@__PURE__*/(function() {
  /**
...
var BufferAppender = /*@__PURE__*/(function() {
  /**
...
var RemoteAppender = /*@__PURE__*/(function() {
  /**
...
var FunctionAppender = /*@__PURE__*/(function() {
  /**
...
var SimpleLoggerProvider = /*@__PURE__*/(function() {
  /**
   * @private
   */
  function logHeader() {
...
'FunctionAppender': FunctionAppender,
'SimpleLoggerProvider': SimpleLoggerProvider
};

module.exports = _virtual_virtualEntrypoint;
